...
export default class ObjectList {
    ...
    private render() {
        ...
        console.log(`[DEBUG ObjectList.render] fullQueue: ${JSON.stringify(fullQueue)}, nextQueuedId: ${nextQueuedId}`);
        console.log(`[DEBUG ObjectList.render] objects on location: ${JSON.stringify(objects.map((o: any) => ({ num: o.num, shortcut: o.shortcut, desc: o.desc })))}`);
