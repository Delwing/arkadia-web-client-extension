...
function apply(settings: UiSettings) {
    ...
    // Apply color theme
    if (document.body) {
        document.body.classList.remove('theme-fantasy', 'theme-forest', 'theme-ice-fire', 'theme-ice-fire-2');
...
function load(): UiSettings {
    try {
        ...
        if (raw || Object.keys(parsed).length > 0) {
            ...
            const colorTheme = (['default', 'fantasy', 'forest', 'ice-fire', 'ice-fire-2'].includes(parsed.colorTheme))
...
export default async function initUiSettings() {
    ...
    function read(): UiSettings {
        ...
        return {
            ...
            colorTheme: (['default', 'fantasy', 'forest', 'ice-fire', 'ice-fire-2'].includes(colorThemeInput?.value) ? colorThemeInput.value : defaultUiSettings.colorTheme) as ColorTheme,
