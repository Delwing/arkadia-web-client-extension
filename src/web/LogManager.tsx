...
export function LogManager({ open, onOpenChange, sessions, onSessionsChanged }: LogManagerProps) {
    ...
    return (
        <>
            <Dialog open={open} onOpenChange={onOpenChange} size="md" className="logs-manage">
                <DialogHeader compact>
                    <DialogTitle>Zarzadzanie logami</DialogTitle>
                ...
                <DialogBody padded>
                    {status ? (
                        <Callout
                            tone={status.tone}
                            icon={status.tone === "danger" ? <Icon name="warning" size={14} /> : undefined}
                        >
                            {status.text}
                        </Callout>
                    ) : null}
                    ...
                    {ordered.length === 0 ? (
                        ...
                        <div className="logs-manage__table-box">
                            <table className="logs-manage__table">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    {ordered.map((session, index) => {
                                        ...
                                        const newYear =
                                            index === 0 || sessionYear(ordered[index - 1]) !== year;
                                        return (
