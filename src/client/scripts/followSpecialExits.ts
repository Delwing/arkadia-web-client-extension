...
export default function initFollowSpecialExits(client: Client) {
    ...
    const entries: Entry[] = [
        ...
        {
            pattern: /wyciagna swa reke i dotyka statui\. O dziwo kamien nie stawia zadnego oporu\./,
            command: "dotknij statui"
        },
        {pattern: /otwiera klape i wydostaje sie przez otwor w suficie na gore\./, command: "otworz klape"},
        {
            pattern: /uklada sie w sarkofagu\. Po chwili wieko zasuwa sie\./,
        ...
        {
            pattern: /uwaznie stawiajac kazdy swoj krok przeciska sie pomiedzy skalami\./,
            command: "przecisnij sie miedzy skalami"
        },
        ...
        {
            pattern: /rozgarnia krzewy probujac sie przez nie przedrzec\. Po chwili znika wewnatrz sciany roslinnosci\./,
            command: "przecisnij sie przez krzaki"
        },
        ...
        {
            pattern: /ostroznie przedziera sie przez sciane galezi rosnacych tu krzakow\./,
            command: "przecisnij sie przez krzaki"
        },
        {
            pattern: /wbiega w krzaki w pospiechu i ze wszystkich sil przedziera sie przez ich galezie\./,
            command: "przecisnij sie przez krzaki"
        },
        {pattern: /przeciska sie przez lukarne\./, command: "przecisnij sie przez lukarne"},
        {
            pattern: /pochyla sie i czolgajac probuje przecisnac sie przez otwor w murze\.\.\. po chwili znika ci z oczu\./,
            command: "przecisnij sie przez otwor"
        },
        ...
        {
            pattern: /odsuwa gelezie z ogromnego glazu i wchodzi przez znajdujacy sie u jego podstawy otwor pod ziemie\./,
            command: "przecisnij sie przez otwor"
        },
        ...
        {
            pattern: /wchodzi do szczeliny miedzy glazami i znika w jej mroku\./,
            command: "przecisnij sie przez szczeline"
        },
        {
            pattern: /podchodzi do szczeliny we wschodniej scianie i szamotajac sie przez moment znika w jej wnetrzu\./,
            command: "przecisnij sie przez szczeline"
        },
        {pattern: /przeciska sie przez znajdujaca/, command: "przecisnij sie przez szczeline"},
        {
            pattern: /wchodzi do szczeliny by po chwili zniknac w jej wnetrzu\./,
            command: "przecisnij sie przez szczeline"
        },
        {pattern: /przywiera plasko do ziemi i wczolguje sie w szczeline\./, command: "przecisnij sie przez szczeline"},
        {
            pattern: /spuszczajac nogi w szczeline siada na ziemi, by po chwili zniknac w otworze\./,
            command: "przecisnij sie przez szczeline"
        },
        {pattern: /znika w kepie brzozek\./, command: "przecisnij sie przez szczeline"},
        {
            pattern: /wciska sie do szczeliny w scianie i po chwili znika z oczu\./,
            command: "przecisnij sie przez szczeline"
        },
        ...
        {
            pattern: /podchodzi pod bluszczowa zaslone\. Rozglada sie chwile, po czym rozwiera/,
            command: "przedrzyj sie przez bluszcz"
        },
        {
            pattern: /podaza na druga strone mostu, stapajac po (\w+) plytkach\./,
            command: m => `przejdz po ${m[1]} plytkach`
        },
        {
            pattern: /podaza na druga strone pieczary, stapajac po (\w+) plytkach\./,
            command: m => `przejdz po ${m[1]} plytkach`
        },
        ...
        {
            pattern: /przesuwa lekko rzezbiony kredens, znikajac w czarnej otchlani jaka sie za nim odslania\./,
            command: "przekrec galke;odsun kredens"
        },
        ...
        {
            pattern: /wchodzi do niezbyt glebokiej wody po piers i przeprawia sie na przeciwlegly brzeg\./,
            command: "przepraw sie przez rzeke"
        },
        {
            pattern: /wchodzi na lod skuwajacy rzeke i ostroznie stawiajac kroki przeprawia sie na przeciwlegly brzeg\./,
            command: "przepraw sie przez rzeke"
        },
        ...
        {
            pattern: /bierze rozped i z latwoscia przeskakuje nad zaglebieniem, podazajac na polnoc\./,
            command: "przeskocz na polnoc"
        },
        {
            pattern: /bierze rozped i z latwoscia przeskakuje nad zaglebieniem, podazajac na poludnie\./,
            command: "przeskocz na poludnie"
        },
        ...
        {
            pattern: /zapiera sie nogami o grunt i probuje uniesc ((?:[\w-]+ )?[\w-]+ \w+)\./,
            command: m => `unies ${m[1]}`
        },
        {
            pattern: /zapiera sie nogami o grunt i probuje uniesc ((?:[\w-]+ )?[\w-]+ \w+) w podlodze\./,
            command: m => `unies ${m[1]}`
        },
        {pattern: /znika nagle\./, command: "wcisnij plaskorzezbe"},
        {
            pattern: /pochyla sie i niemal na czworaka wciska sie do wneki pod rumowiskiem, aby po chwili zupelnie w niej zniknac\./,
            command: "wcisnij sie do wneki"
        },
        {
            pattern: /calkiem sprawnie radzac sobie ze wspinaczka po korzeniach, podaza w kierunku powierzchni ziemi\./,
            command: "wdrap sie na gore"
        },
        {pattern: /zaczyna wspinac sie na gore\./, command: "wejdz na gore"},
        {pattern: /zaczyna wspinac sie po skarpie na gore\./, command: "wejdz na gore"},
        {pattern: /zaczyna wspinac sie na polke\./, command: "wejdz na gore"},
        {pattern: /zaczyna wspinac sie po wielkich glazach skalnego rumowiska\./, command: "wejdz na gore"},
        {pattern: /zaczyna wspinac sie po scianie/, command: "wejdz na gore"},
        {pattern: /zaczyna wspinac sie na gran\./, command: "wejdz na gore"},
        {pattern: /zaczyna wspinac sie na uskok\./, command: "wejdz na gore"},
        {pattern: /zaczyna wspinac sie na sciane\./, command: "wejdz na gore"},
        {pattern: /wchodzi po kreconych schodach na gore\./, command: "wejdz na gore"},
        {pattern: /zaczyna powoli wchodzic do gory\./, command: "wejdz na gore"},
        {
            pattern: /przechodzi szybko przez rozmyty row wyschnietej fosy i zabiera sie za wspinaczke po ogromnym gruzowisku\./,
            command: "wejdz na gore"
        },
        {pattern: /lapie sie za liny i zaczyna wspinac sie do gory\./, command: "wejdz na gore"},
        {
            pattern: /^Niepewnie lapiac sie bardziej wystajacych kamieni \w+ zaczyna wolno wspinac sie na gore\.$/,
            command: "wejdz na gore"
        },
        {pattern: /^Kamien po kamieniu \w+ zaczyna wspinac sie na polke skalna\.$/, command: "wejdz na gore"},
        {pattern: /zaczyna wspinac sie po rumowisku\./, command: "wejdz na gore"},
        ...
        {
            pattern: /znika w glebinach komina, pomagajac sobie przy tym wolna reka\./,
            command: () => `opusc bronie;wejdz do komina;${client.drawWeaponCommand} wszystkich broni`
        },
        {
            pattern: /mocno odbija sie stopami od podloza i zaczyna wspinaczke wglab tunelu\./,
            command: () => `opusc bronie;wejdz do komina;${client.drawWeaponCommand} wszystkich broni`
        },
        ...
        {pattern: /zaczyna sie powoli opuszczac przez gleboka wyrwe w murze\./, command: "zejdz na dol"},
        {pattern: /zsuwa sie po skarpie\./, command: "zejdz na dol"},
        {pattern: /zaczyna schodzic na dol\./, command: "zejdz na dol"},
        {pattern: /lapiac sie wystajacych odlamkow skalnych schodzi w dol\./, command: "zejdz na dol"},
        {pattern: /spoglada na dol i ostroznie zsuwa sie tam\./, command: "zejdz na dol"},
        {pattern: /smialo zaczyna schodzic w dol i po chwili znika ci z oczu\./, command: "zejdz na dol"},
        {pattern: /zaczyna schodzic po scianie\./, command: "zejdz na dol"},
        {pattern: /zaczyna schodzic do niecki\./, command: "zejdz na dol"},
        {pattern: /zaczyna schodzic po skarpie\./, command: "zejdz na dol"},
        {pattern: /zaczyna schodzic do jamy\./, command: "zejdz na dol"},
        {pattern: /schodzi po kreconych schodach na dol\./, command: "zejdz na dol"},
        {pattern: /wciska sie do skalnego szybu i zaczyna schodzic na dol\./, command: "zejdz na dol"},
        {pattern: /wychyla sie przez okno i zaczyna schodzic na dol\./, command: "zejdz na dol"},
        {pattern: /zaczyna powoli schodzic na dol\./, command: "zejdz na dol"},
        {pattern: /uwaznie stawiajac kazdy swoj krok zsuwa sie posrod skal\./, command: "zejdz na dol"},
        {pattern: /lapie za liny i zaczyna schodzic na dol\./, command: "zejdz na dol"},
        {pattern: /zaczyna schodzic po skarpie na dol\./, command: "zejdz na dol"},
        {
            pattern: /^Wykorzystujac platanine galezi mocno przywierajaca do skalnej sciany \w+ zaczyna powoli schodzic na dol\.$/,
            command: "zejdz na dol"
        },
        {
            pattern: /^Niepewnie lapiac sie bardziej wystajacych kamieni \w+ zaczyna wolno opuszczac sie w dol\.$/,
            command: "zejdz na dol"
        },
