...
/**
 * Polish number words to integers converter
 * Used to parse body count responses from MUD
 */
const polishNumberWords: Record<string, number> = {
 ...
 */
function polishWordToNumber(word: string): number {
