...
export const defaultSettings: Settings = {
    ...
    collectOverrides: [
        ...
        { enemy: 'zywiolak ziemi', collectCopper: false, collectSilver: true, collectGold: true, collectGems: true, collectExtra: [] },
        { enemy: 'zywiolak wody', collectCopper: false, collectSilver: true, collectGold: true, collectGems: true, collectExtra: [] },
        { enemy: 'zywiolak powietrza', collectCopper: false, collectSilver: true, collectGold: true, collectGems: true, collectExtra: [] },
        { enemy: 'zywiolak ognia', collectCopper: false, collectSilver: true, collectGold: true, collectGems: true, collectExtra: [] },
    ],
    language: 'potoczna',
    languageAdjective: '',
    languageAliases: [],
