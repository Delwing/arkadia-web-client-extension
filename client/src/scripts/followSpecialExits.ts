...
export default function initFollowSpecialExits(client: Client) {
    ...
    const entries: Entry[] = [
        ...
        { pattern: /znika w glebinach komina, pomagajac sobie przy tym wolna reka\./, command: () => `opusc bronie;wejdz do komina;${client.drawWeaponCommand} wszystkich broni` },
        { pattern: /mocno odbija sie stopami od podloza i zaczyna wspinaczke wglab tunelu\./, command: () => `opusc bronie;wejdz do komina;${client.drawWeaponCommand} wszystkich broni` },
        ...
        { pattern: /^Wykorzystujac platanine galezi mocno przywierajaca do skalnej sciany \w+ zaczyna powoli schodzic na dol\.$/, command: "zejdz na dol" },
        { pattern: /^Niepewnie lapiac sie bardziej wystajacych kamieni \w+ zaczyna wolno opuszczac sie w dol\.$/, command: "zejdz na dol" },
