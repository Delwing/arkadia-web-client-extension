...
export default function initFollowSpecialExits(client: Client) {
    ...
    const entries: Entry[] = [
        ...
        { pattern: /przechodzi szybko przez rozmyty row wyschnietej fosy i zabiera sie za wspinaczke po ogromnym gruzowisku\./, command: "wejdz na gore" },
        { pattern: /lapie sie za liny i zaczyna wspinac sie do gory\./, command: "wejdz na gore" },
        { pattern: /^Niepewnie lapiac sie bardziej wystajacych kamieni \w+ zaczyna wolno wspinac sie na gore\.$/, command: "wejdz na gore" },
