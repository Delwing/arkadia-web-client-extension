import { Recorder as RecorderBase, type RecorderHooks, type RecordedEvent, type RecorderStorage } from "@shared/recorder";
import { saveRecording, getRecording, getRecordingNames, deleteRecording } from "./recordingStorage";
import { type CommandOptions } from "@client/src/scripts/commandPreserveCaseMode.ts";
