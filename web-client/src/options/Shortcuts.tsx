...
function Shortcuts() {
    ...
    const currentRoomId = useUiStore((state) => state.map.currentRoomId);
                ...
                {list.map(item => (
                    <tr key={item.key}>
                        ...
                        <td className="d-flex gap-2">
                            <Button size="sm" onClick={() => getCommandDispatcher().sendEvent('leadTo', item.id)}>Prowadź</Button>
